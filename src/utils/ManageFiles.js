export default class GestionArchivos {
  /**
   ...
   */
  static async pdfToBase64(archivo) {
   ...
   */
  static descargarPdf(base64, nombreArchivo = "documento.pdf") {
    const blob = this.base64APdf(base64);
