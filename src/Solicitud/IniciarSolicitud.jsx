...
const [mensaje, setMensaje] = useState({ texto: "", tipo: "" });
 ...
 {!dependenciasCargadas && (
  ...
  const handleInputChange = (field, value) => {
   ...
   const handleSubmit = async (e) => {
    ...
    if (!formData.folio.trim() && !formData.hermes.trim()) {
      setMensaje({ texto: "⚠️ Debes ingresar al menos un Folio o Hermes de notificación", tipo: "error" });
      return;
    }
    ...
    try {
      ...
      for (let i = 0; i < cantidad; i++) {
        ...
        if (tipoSolicitud === "bolsa") {
          response = await solicitudServicio.crearSolicitudBolsaTrabajo(dataConCandidato, token, tipoSolicitud);
        } else {
          response = await solicitudServicio.crearSolicitudAsignacionRequisicion(dataConCandidato, token, tipoSolicitud);
        }
        console.log(`Solicitud ${i + 1} creada:`, response);
      }

      setMensaje({ texto: `✅ ${cantidad > 1 ? `${cantidad} solicitudes creadas correctamente` : "Solicitud creada correctamente"}`, tipo: "exito" });         
      setTimeout(() => {
  ...
  if (dep) {
    ...
    setMensaje({ texto: "⚠️ No se encontró la dependencia ingresada", tipo: "error" });
  }
};
 ...
 return (
      ...
      <form className="form-grid" onSubmit={handleSubmit}>
        ...
        {/* Campos comunes para ambos tipos */}
          ...
          <div className="form-group">
            ...
            <div className="form-group">
              <label className="form-label-solicitud">Hermes de Notificación</label>
              <input
                type="text"
                className="form-input-solicitud"
        ...
        <div className="form-group-solicitud" style={{ position: 'relative' }}>
  <label className="form-label-solicitud">Número de Entidad académica o Dependencia</label>
  <div className="input-with-icon">
    ...
    />
        ...
        <div className="form-group-solicitud">
          <label className="form-label-solicitud">Entidad académica o Dependencia</label>
          <input
            type="text"
            className="form-input-solicitud"
        ...
        <div className="form-group-solicitud">
          <label className="form-label-solicitud">Área Organizacional</label>
          <input
            type="text"
            className="form-input-solicitud"
            value={formData.area}
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => handleInputChange('tipoPersonal', e.target.value)}
          >
          ...
          <div className="form-group-solicitud">
            <label className="form-label-solicitud">Fecha de Elaboración Propuesta</label>
            <input
              type="date"
              className="form-input-solicitud"
              value={formData.fechaPropuesta}
              onChange={(e) => handleInputChange('fechaPropuesta', e.target.value)}
            />
          </div>

          <div className="form-group-solicitud">
            <label className="form-label-solicitud">Fecha de liberación de oficio</label>
            <input
              type="date"
              className="form-input-solicitud"
          ...
          <div className="form-group-solicitud">
            <label className="form-label-solicitud">Periodo Autorizado en oficio (inicio)</label>
            <input
              type="date"
              className="form-input-solicitud"
          ...
          <div className="form-group-solicitud">
            <label className="form-label-solicitud">Periodo Autorizado en oficio (término)</label>
            <input
              type="date"
              className="form-input-solicitud"
              value={formData.periodoTermino}
              onChange={(e) => handleInputChange('periodoTermino', e.target.value)}
            />
          </div>

          <div className="form-group-solicitud">
            <label className="form-label-solicitud">Categoría autorizada en oficio</label>
            <input
              type="text"
              className="form-input-solicitud"
          ...
          <div className="form-group-solicitud" style={{ gridColumn: "span 3" }}>
            <label className="form-label-solicitud">Observaciones Registro</label>
            <textarea
          ...
          <h3 className="section-title">Datos del proceso</h3>            
              <div className="form-group">
                <label className="form-label-solicitud">Número Carpeta </label>
                <input type="text" className="form-input-solicitud"
              ...
              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Nombre de Candidato</label>
                <input
                  type="text"
                  className="form-input-solicitud"
              ...
              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Función a desempeñar</label>
                <input
                  type="text"
                  className="form-input-solicitud"
              ...
              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Familia Funcional</label>
                <input
                  type="text"
                  className="form-input-solicitud"
              ...
              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Fecha Entrevista</label>
                <input
                  type="date"
                  className="form-input-solicitud"
              ...
              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Fecha Evaluación competencias</label>
                <input
                  type="date"
                  className="form-input-solicitud"
                  value={formData.fechaCompetencias}
                  onChange={(e) => handleInputChange('fechaCompetencias', e.target.value)}
                />
              </div>

              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Fecha Se inicia procesamiento</label>
                <input
                  type="date"
                  className="form-input-solicitud"
                  value={formData.fechaProcesamiento}
                  onChange={(e) => handleInputChange('fechaProcesamiento', e.target.value)}
                />
              </div>

              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Resultado Evaluación conocimiento</label>
                <input
                  type="text"
                  className="form-input-solicitud"
                  value={formData.resultadoConocimiento}
                  onChange={(e) => handleInputChange('resultadoConocimiento', e.target.value)}
                />
              </div>

              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Experiencia laboral solicitada</label>
                <input
                  type="text"
                  className="form-input-solicitud"
              ...
              <div className="form-group-solicitud">
                <label className="form-label-solicitud">Fecha Envío a DEyDP</label>
                <input
                  type="date"
                  className="form-input-solicitud"
                  value={formData.fechaEnvioDes}
                  onChange={(e) => handleInputChange('fechaEnvioDes', e.target.value)}
                />
              </div>
              ...
              <div className="form-group">
                <label className="form-label-solicitud">Fecha Revisión OfiEval</label>
                <input type="date" className="form-input-solicitud"
                  value={formData.fechaOfiEval}
                  onChange={(e) => handleInputChange('fechaOfiEval', e.target.value)}
                />
              </div>

              <div className="form-group">
                <label className="form-label-solicitud">Fecha Notificación</label>
                <input type="date" className="form-input-solicitud"
              ...
              <div className="form-group">
                <label className="form-label-solicitud">Tiempo del proceso</label>
                <input type="text" className="form-input-solicitud"
              ...
              <div className="form-group">
                <label className="form-label-solicitud">Fecha de evaluación de desempeño</label>
                <input type="date" className="form-input-solicitud"
                  value={formData.fechaEvaluacionDesempenio}
                  onChange={(e) => handleInputChange('fechaEvaluacionDesempenio', e.target.value)}
                />
              </div>

              <div className="form-group" style={{ gridColumn: "span 3" }}>
                <label className="form-label-solicitud">Observaciones Analista</label>
                <textarea className="large-textarea"
                  value={formData.observacionesAnalista}
                  onChange={(e) => handleInputChange('observacionesAnalista', e.target.value)} />
              </div>

              <div className="form-group">
                <label className="form-label-solicitud">Consecutivo Expediente Físico</label>
                <input type="text" className="form-input-solicitud"
                  value={formData.consecutivoExpediente}
                  onChange={(e) => handleInputChange('consecutivoExpediente', e.target.value)}
                />
              </div>

              <div className="form-group">
                <label className="form-label-solicitud">Seguimiento Evaluación Desempeño</label>
                <select 
                  className="form-input-solicitud"
              ...
              <div className="form-group">
                <label className="form-label-solicitud">Resultado Seguimiento Evaluación Desempeño</label>
                <input type="text" className="form-input-solicitud"
                  value={formData.resultadoSeguimiento}
                  onChange={(e) => handleInputChange('resultadoSeguimiento', e.target.value)}
                />
              </div>
            </>
          )}
      ...
      <div className="form-group-solicitud">
        <label className="form-label-solicitud">Cantidad de candidatos</label>
        <input
          type="number"
          min="1"
          className="form-input-solicitud"
          ...
          onChange={(e) => {
            ...
            const nuevosCandidatos = Array.from({ length: cantidad }, (_, i) => ({
...
<div style={{ gridColumn: "1 / -1" }}>
  {formData.candidatos.map((candidato, index) => (
    <div key={index} className="candidato-section">
      ...
      <div className="form-group-solicitud">
        <label className="form-label-solicitud">Fecha de cita</label>
        <input
          type="date"
          className="form-input-solicitud candidato-input"
        ...
        />
          ...
          <div className="form-group-solicitud action-buttons" style={{ gridColumn: "span 3" }}>
