      ...
      useEffect(() => {
        if (solicitudSeleccionada && Object.keys(solicitudSeleccionada).length) {
          setFormData({
            ...
            ? new Date(solicitudSeleccionada.fechaEntrevista).toISOString().split('T')[0]
            : "",
...
const handleEliminar = async () => {
      try {
        ...
        await solicitudServicio.eliminarProcesoPorID(idProceso, token);
        setMostrarPopup(false);
        setMensaje({ texto: "🗑️ Solicitud eliminada correctamente", tipo: "exito" });
        ...
        const errorMsg = error.mensaje || error.message || "Error desconocido al eliminar.";
    ...
    const handleSubmit = async (e) => {
      ...
      const { tipo, ...datosAEnviar } = formData;
      ...
      try {
        if (!formData.analista || formData.analista === "") {          
          await solicitudServicio.editarSolicitud(
            solicitudSeleccionada.idProceso,
            datosAEnviar,
            token
          );

          setMensaje({ texto: "✅ Solicitud actualizada correctamente", tipo: "exito" });
          ...
          setMensaje({ texto: "✅ Solicitud asignada a analista", tipo: "exito" });
          setTimeout(() => navigate("/solicitudes"), 2000);
          setTimeout(() => setMensaje(""), 3000);
        }
      } catch (error) {
        ...
        <div className={`mensaje-flotante ${mensaje.tipo}`}>
          ...
          <div className="contenido-asignacion-inner">
            <form className="form-grid" onSubmit={handleSubmit}>
              ...
              <div className="form-group">
                <label className="form-label-evaluacionl">Nombre de Candidato</label>
                <input
                  type="text"
                  className="form-input"
              ...
              <div className="form-group">
                <label className="form-label-evaluacionl">Familia Funcional</label>
                <select
                  className="form-input"
                  value={formData.familia}
                  onChange={(e) => handleInputChange("familia", e.target.value)}
                >
                  <option value="" disabled hidden>Seleccionar familia funcional</option>
                  <option value="N1. Académico Administrativo">N1. Académico Administrativo</option>
                  <option value="N2. Administrativo Académico">N2. Administrativo Académico</option>
                  <option value="N3. Administrativo">N3. Administrativo</option>
                  <option value="N4. Normativo, jurídico, legal">N4. Normativo, jurídico, legal</option>
                  ...
                  <option value="N9. Presupuestal-contable">N9. Presupuestal-contable</option>
                  <option value="N10. Comunicación y edición">N10. Comunicación y edición</option>
              ...
              <div className="form-group">
                <label className="form-label-evaluacionl">Función a Desempeñar</label>
                <Select
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange("educacionFormal", e.target.value)}
                />
              </div>
...
<div className="form-group">
  ...
  <div className="avalado-buttons">
    {["Título", "Cédula", "Certificado", "Kárdex", "Constancia"].map((opcion) => (
      <button
        key={opcion}
        type="button"
      ...
      >
        {opcion}
            ...
            <div className="checkbox-group-solicitud" style={{ paddingRight: "300px", paddingBottom: "20px" }}>
              <label
              ...
              <input
                ...
                onChange={(e) => handleInputChange("citaVirtual", e.target.checked)}
              />
            </div>
            ...
            <div className="form-group" style={{ gridColumn: "1 / -1" }}>
              ...
              {permiteAsignarAnalista && (
                <div className="form-group analista-combobox">
                  <label className="form-label-evaluacionl" style={{ fontSize: '14px', fontWeight: 700 }}>Analista</label>
                  <select
                    className="form-input"
                    value={formData.analista}
                    onChange={(e) => handleInputChange("analista", e.target.value)}
                  >
                    <option value="" disabled hidden>Seleccionar</option>
          ...
          <div className="popup-overlay">
            <div className="popup">
              ...
              <div className="popup-buttons">
                <button className="btn-confirmar" onClick={handleEliminar}>Aceptar</button>
